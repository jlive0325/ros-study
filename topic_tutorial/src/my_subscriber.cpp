...
void msgCallback(const topic_tutorial::my_msg::ConstPtr& msg)   // 메시지 콜백함수, 서브스크라이버가 메시지를 수신했을 때 동작하는 함수이다.
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber my_sub = nh.subscribe("my_topic", 100, msgCallback);    // 서브스크라이버 선언
