...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        msg.data = cnt
        rospy.loginfo("send msg-stamp.secs_3_2 = %d", msg.stamp.secs)
        rospy.loginfo("send msg-stamp.nsecs_3_2 = %d", msg.stamp.nsecs)
        rospy.loginfo("send msg-data_3_2 = %d", msg.data)
        cnt += 2
        pub.publish(msg)
        loop_rate.sleep()
...
int main(int argc, char **argv)
{
    ...
    ros::Rate loop_rate(5); // 루프 추가를 10Hz로 설정한다.
